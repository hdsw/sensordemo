...
package com.bytereal.sensor6050demo.service;
...
public class BluetoothLeService extends Service {
	...
	//	MyLog.i(TAG, "broadcastUpdate characteristic");
		...
		//		MyLog.i(TAG, "Broadcast EXTRA_DATA="+stringBuilder.toString());
	...
	public boolean connect(final String address) {
		...
		//已经连接过设备重新连�?		// Previously connected device. Try to reconnect. (��ǰ���ӵ��豸�� ������������)
